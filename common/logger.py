...
def init(log_dir="storage/logs/", log_lvl=_logging.INFO, log_mod=LogMode.DAILY, log_fmt=LogFormat.TIMESTAMP):
    """
    ...
    log_file_fmt = log_dir + _sys.argv[0].rsplit('.', 1)[0] + "{0}.log"
